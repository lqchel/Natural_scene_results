            ...
            for s = 1:2
                for d = 1:2
                 ...
                 if image_index_s(s,d)== P_index && center_or_periphery(a,1) == 1
                     filename_C = fullfile('C:\Users\liang\OneDrive\Documents\honours\research project\Natural_scene_results\Find_Critical_Object_Example\cong_patches',...
                         ['cong_',num2str(a),'_', num2str(patch_number_s(s,d)),'_p', '.jpg']);
                     filename_I = fullfile('C:\Users\liang\OneDrive\Documents\honours\research project\Natural_scene_results\Find_Critical_Object_Example\incong_patches',...
